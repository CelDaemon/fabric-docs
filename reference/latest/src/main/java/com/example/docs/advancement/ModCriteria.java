...
public class ModCriteria {
	public static final UseToolCriterion USE_TOOL = CriteriaTriggers.register(ExampleMod.id("use_tool").toString(), new UseToolCriterion());
	// #endregion datagen_advancements_mod_criteria

	// #region datagen_advancements_new_mod_criteria
	public static final ParameterizedUseToolCriterion PARAMETERIZED_USE_TOOL = CriteriaTriggers.register(ExampleMod.id("parameterized_use_tool").toString(), new ParameterizedUseToolCriterion());
